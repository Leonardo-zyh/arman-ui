...
// export {
//     AIcon,AButton,AButtonGroup,AInput,ARow,ACol,ATabs,ATabsTabW,ATabsContentW,ATabsContent,ATabsTab,ACollapse,ACollapseItem,AToastPlugin
// }
Vue.component('AIcon', _AIcon.default);
Vue.component('AButton', _AButton.default);
Vue.component('AButtonGroup', _AButtonGroup.default);
Vue.component('AInput', _AInput.default);
Vue.component('ARow', _ARow.default);
Vue.component('ACol', _ACol.default);
Vue.component('ATabs', _ATabs.default);
Vue.component('ATabsTabW', _ATabsTabW.default);
Vue.component('ATabsTab', _ATabsTab.default);
Vue.component('ATabsContentW', _ATabsContentW.default);
Vue.component('ATabsContent', _ATabsContent.default);
Vue.component('ACollapse', _ACollapse.default);
Vue.component('ACollapseItem', _ACollapseItem.default);
Vue.use(_AToastPlugin.default);
